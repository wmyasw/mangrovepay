...
import com.jdjt.mangrovepay.adpater.ChannelPayAdapter.ViewHolder;
 ...
 **************************************************/
public class ChannelPayAdapter extends
		CommonLazyAdapter<HashMap<String, String>, ViewHolder> {
	private ArrayList<HashMap<String, String>> dataList;

	public ChannelPayAdapter(AbsListView listView,
				...
				try {
					...
					if (TextView.class.isAssignableFrom(object.getClass())) {
						if ("tx_kyed".equals(field.getName())) {
							if (!Handler_String.isBlank(dataList.get(position)
									.get("tx_kyed"))) {
	...
	public class ViewHolder extends BaseViewHolder{
		...
		**************************************************/
		...
		private static final long serialVersionUID = 6104676359786189432L;
		@InjectView(R.id.tx_channel_name)
		public TextView tx_channel_name;
		@InjectView(R.id.tx_channel_code)
		public TextView tx_channel_code;
		@InjectView(R.id.img_ischecked)
		public ImageView img_ischecked;
		@InjectView(R.id.tx_kyed)
		public TextView tx_kyed;
