...
public class BadgeView extends TextView {
	...
	private void init(Context context, View target, int tabIndex) {
		...
		// apply defaults
		badgePosition = DEFAULT_POSITION;//设置默认显示位置
		badgeMarginH = dipToPixels(DEFAULT_MARGIN_DIP); //设置边距
		badgeMarginV = badgeMarginH;
		badgeColor = DEFAULT_BADGE_COLOR;//默认颜色
...
//			target = ((RadioGroup) target).getChildAt(targetTabIndex);
	...
	/*************************************************
	 @Title: setWidthAndHight 
	 @Description: TODO(设置圆的直径) 
	 @param dp    设定文件 
	 @return void    返回类型 
	 @throws 
	 @date  2015-2-5
	*************************************************/
	public void setWidthAndHight(int dp){
		this.setWidth(dipToPixels(dp));
		this.setHeight(dipToPixels(dp));
	}
